    ...
    translation: {
      ...
      room: {
        ...
        finishReason: {
          ...
          perspective: {
            wonByFive: 'You made five in a row first',
            lostByFive: 'Opponent made five in a row first',
            opponentTimeout: 'Opponent timed out, you win',
            selfTimeout: 'You timed out and lost',
          },
        },
